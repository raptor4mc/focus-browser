...
fn main() {
    ...
    println!("[VERBOSE] P5 layout: takes styled flat DOM from P4, outputs positioned rectangles via taffy");
    ...
    println!("[VERBOSE] P5 layout: computed {} LayoutBox — x/y/w/h from taffy", layout.len());
